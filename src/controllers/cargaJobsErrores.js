        ...
        if (errores.length > 0){
            ...
            for (this.longErrores in errores) {
                ...
                if (arrayJobsCreados.length > 0){
                    ...
                    this.point = [
                        errores[this.longErrores].geometria.coordinates[0],
                        errores[this.longErrores].geometria.coordinates[1],
                    ];

                    for (this.longJobs in jobs){
                        this.polygon = [jobs[this.longJobs].geometria.coordinates[0]];
            ...
            for (this.longErrores in errores){
                ...
                if (errores[this.longErrores].id_error != null){
                    ...
                    await database.query("UPDATE got.errores SET id_job = $1, error = $2, id_tema_error = $3, id_tipo_error = $4, descripcion = $5, id_estado_error = $6, geometria = ST_GeomFromText($7 \,\'3857\'), id_via_ent = $8 WHERE id_error = $9",[
                        ...
                        stringifyErrorGeometry(errores[this.longErrores].geometria),
                    ...
                    await database.query("INSERT INTO got.errores (id_job, error, id_tema_error, id_tipo_error, descripcion, id_estado_error, geometria, id_via_ent) VALUES ($1, $2, $3, $4, $5, $6, ST_GeomFromText($7 \,\'3857\'), $8)",[
                        errores[this.longErrores].job,
                        errores[this.longErrores].error,
                        transformer('temasError', errores[this.longErrores].tema_error),
                        transformer('tiposError', errores[this.longErrores].tipo_error),
